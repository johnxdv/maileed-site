...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className="glow-orb left-[12%] top-[18%] h-72 w-72 animate-float bg-accent/25"
      ...
      />
      <div
        className="glow-orb bottom-[8%] left-[40%] h-64 w-64 animate-float bg-accent/15"
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="mt-12 w-full max-w-2xl">
          <div className="group relative aspect-video w-full cursor-pointer overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl transition-all duration-400 hover:border-accent/40 hover:shadow-glow">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="flex h-20 w-20 items-center justify-center rounded-full border border-accent/40 bg-accent/15 backdrop-blur-sm transition-transform duration-300 group-hover:scale-110">
                ...
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                  <path d="M8 5.5v13l11-6.5z" fill="#7A52CC" />
                </svg>
              </span>
            </div>
          </div>
        ...
        <motion.p variants={fadeInUp} className="mt-12 text-sm text-white/45">
